...
```{r}          
    ...
    newRerun <- 2  #change to 1 for rerun or 2 for rescrape the website

    files.df <- HA_ForumRefresh(newRerun) 
...
#     dtmss <- removeSparseTerms(dtm, 0.50) 
#      # This makes a matrix that 2s only 50% empty space, maximum.   
#        
